...
TOPIC: dict = {
    ...
    'theory': {
        ...
        'schemes': [
            {
                'title': 'Схема: тестовые данные → ввод пользователя',
                'body': (
                    'Нарисовать две колонки. Слева версия 0.4: product = "Яблоко", grams = 100 внутри кода. '
                    'Справа версия 0.5: product = input(), grams = int(input()). '
                    'Стрелка показывает: те же переменные остаются, меняется источник данных.'
                ),
                'placeholder': True,
            },
            {
                'title': 'Схема: путь данных в версии 0.5',
                'body': (
                    'Пользователь вводит продукт и граммы → input() получает строки → int() превращает граммы в число → '
                    'переменные product и grams готовы для следующей версии с формулой.'
                ),
                'placeholder': True,
            },
        ],
