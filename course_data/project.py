...
10 этапов (0.1 … 1.0) — короткие итоги для панели прогресса.
"""
...
PROJECT_LINE: dict[int, dict] = {
    1: {
        'feature': 'Алгоритм калькулятора калорий готов',
        'goal': 'Понять алгоритм калькулятора как цепочку шагов.',
        'version': '0.1',
        'version_label': '0.1',
    },
    2: {
        'feature': 'Основа калькулятора калорий создана',
        'goal': 'Запуск программы и первый вывод.',
        'version': '0.2',
        'version_label': '0.2',
    },
    3: {
        'feature': 'Интерфейс калькулятора калорий готов',
        'goal': 'Название и приветствие пользователю.',
        'version': '0.3',
        'version_label': '0.3',
    },
    4: {
        'feature': 'Система хранения данных подготовлена',
        'goal': 'Хранение данных в переменных.',
        'version': '0.4',
        'version_label': '0.4',
    },
    5: {
        'feature': 'Ввод данных в калькулятор работает',
        'goal': 'Ввод продукта и граммов.',
        'version': '0.5',
        'version_label': '0.5',
    },
    6: {
        'feature': 'Расчёт калорий реализован',
        'goal': 'Расчёт калорий по формуле.',
        'version': '0.6',
        'version_label': '0.6',
    },
    7: {
        'feature': 'Обработка пользовательского ввода настроена',
        'goal': 'Корректная работа с ответами пользователя.',
        'version': '0.7',
        'version_label': '0.7',
    },
    8: {
        'feature': 'Определение выбранного продукта реализовано',
        'goal': 'Выбор продукта через if/elif.',
        'version': '0.8',
        'version_label': '0.8',
    },
    9: {
        'feature': 'Система рекомендаций добавлена',
        'goal': 'Рекомендации по итоговым калориям.',
        'version': '0.9',
        'version_label': '0.9',
    },
    10: {
        'feature': 'Режим повторного расчёта реализован',
